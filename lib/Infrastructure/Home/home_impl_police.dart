...
@LazySingleton(as: HomeServicePolice)
class HomeRepoPoliceImpl implements HomeServicePolice {
  @override
  Future<Either<MainFailure, NearbyPlaces>> getPoliceStation(
    ...
    final response = await dio.get(
        'https://maps.googleapis.com/maps/api/place/textsearch/json?query=policestation+near+$placeName&key=$apiKey');
